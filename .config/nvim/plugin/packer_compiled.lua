...
_G.packer_plugins = {
  ...
  ["flog-forest"] = {
    loaded = true,
    path = "/home/taka15/.local/share/nvim/site/pack/packer/start/flog-forest",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-git", "cmp-latex-symbols", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "nvim-autopairs", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-autotag", "nvim-ts-rainbow", "playground", "neorg", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
...
try_loadstring("\27LJ\2\ng\0\0\3\1\3\0\6-\0\0\0009\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\0\0009let g:flog_default_arguments = { 'max_count': 2000 }\17nvim_command\bapi\0", "setup", "vim-flog")
